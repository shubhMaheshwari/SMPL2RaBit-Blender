...
def gen_centerpiece(context,shape_count = 100):
    
     
    current_location = mathutils.Vector((0,0,0))
    current_spin = mathutils.Vector((0,0,0))  
    ...
    for i in range(shape_count):
        ...
        # Create Cylinder
        bpy.ops.mesh.primitive_cylinder_add(vertices=vertices, radius=radius, depth=0.1, enter_editmode=False, 
        ...
        # Translate each cylinder
        current_location.z = -i*0.1     
#        bpy.ops.transform.translate(value=current_location, orient_type='GLOBAL', 
...
#            use_snap_nonedit=True, use_snap_selectable=False, alt_navigation=True)
        obj.location = current_location

        # Spin each object 
        current_spin.z = math.pi*0.01*i                  
#        bpy.ops.transform.rotate(value=current_spin.z, orient_axis='Z', orient_type='GLOBAL', 
#            orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL', 
#            constraint_axis=(False, False, True), mirror=False, use_proportional_edit=False, 
#            proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, 
...
#            use_snap_selectable=False, alt_navigation=True)
        obj.rotation_euler = current_spin
        ...
        obj.rotation_euler.z += math.radians(360/vertices)*2
