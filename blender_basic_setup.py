...
# import utils 
cur_file_path = bpy.context.space_data.text.filepath
BLENDER_RENDER_DIR,_ = os.path.split(cur_file_path)
print("BLENDER_RENDER_DIR",BLENDER_RENDER_DIR,os.path.split(BLENDER_RENDER_DIR))
HOME_DIR,_ = os.path.split(BLENDER_RENDER_DIR)

print("adasddas",HOME_DIR)

RABIT_DIR  = os.path.join(HOME_DIR,'RaBit')
SRC_DIR  = os.path.join(HOME_DIR,'src')

# sys.path.extend([RABIT_DIR,SRC_DIR])

# for x in sys.path: 
#     if type(x) == str:
#         print(x,os.path.isdir(x))
