# This file takes a smpl pose params and retargets it to RaBit: https://gaplab.cuhk.edu.cn/projects/RaBit
# Basic Imports
import os
import sys
import random
...
# Local modules 
#sys.path.append(os.path.split(bpy.context.space_data.text.filepath)[0])
#print(sys.path)
import blender_basic_setup as bbs # Contains all the details about scene, camera, lights 


class RaBitModel():
    """
        This class stores the information about the RaBit model for .
        This model was built by numpy, exclude eyes rebuild.

    """
    def __init__(self):

        dataroot = os.path.join(bbs.RABIT_DIR,"rabit_data/")
